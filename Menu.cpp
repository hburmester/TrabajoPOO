...
enum class Opciones {Agregar=1, Remover, Mostrar, Listar, Editar, Ubicar, MejoresTotal, MejoresTipo};
...
void Menu::mostrarMenu() {
    ...
    cout << "3. Dibujar Mapa\n";
    cout << "4. Mostrar Objetos\n";
    cout << "5. Editar Objetos\n";
    cout << "6. Ubicar 3 objetos cercanos\n";
    cout << "7. Mostrar top 3 total\n";
    cout << "8. Mostrar top 3 un tipo\n";
    cout << "0. Para Salir\n\n";
}
